/**
 * ACF5 is otherwise same as ACF2 except for changes in:
 * ACVS: ratio becomes 3:1
 * ACF: shapes become squares, pentagons, and diamonds, and ratio increases
 */
exp.ACF5 = class extends exp.ExperimentKernel {
    constructor() {
        ...
        const INSTR_ROOT = "https://exp.leberatory.org/files/instr/acf5/";
