/**
 * ACOL-12 tries to assess the correlation of optimality between standard acvs
 * and the modified color-cue acvs.
 * 
 * @author Walden Li
 */
exp.ACOL12 = class extends exp.ExperimentKernel {
    ...
    constructor() {
        ...
        // Set up the database
        //
        this._db.experiment_type = "ACOL-12";
        ...
        const INSTR_ROOT = "https://psy-ccl.asc.ohio-state.edu/files/instr/acol-12/";
