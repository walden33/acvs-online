...
exp.ACMC1 = class extends exp.ExperimentKernel {
    constructor() {
        ...
        this.add_new_step(new exp.ACMCBlock(this._db, 1, new disp.ACMouseContDisplayGenerator1(40)));
        this.add_new_step(new exp.ACMCBlock(this._db, 2, new disp.ACMouseContDisplayGenerator1(40)));
        this.add_new_step(new exp.ACMCBlock(this._db, 3, new disp.ACMouseContDisplayGenerator1(40)));
