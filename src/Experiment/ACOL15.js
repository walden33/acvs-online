/**
 * ACOL-15 is the same task with 14 but with a 350 ms inter-frame interval
 * 
 * @author Walden Li
 */
exp.ACOL15 = class extends exp.ExperimentKernel {
    ...
    constructor() {
        ...
        // Set up the database
        //
        this._db.experiment_type = "ACOL-15";
        ...
        const INSTR_ROOT = "https://psy-ccl.asc.ohio-state.edu/files/instr/acol-15/";
