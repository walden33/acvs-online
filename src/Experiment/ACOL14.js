/**
 * ACOL-14 the same Temporal ACVS task with a different cue
 * 
 * @author Walden Li
 */
exp.ACOL14 = class extends exp.ExperimentKernel {
    ...
    constructor() {
        ...
        // Set up the database
        //
        this._db.experiment_type = "ACOL-14";
        ...
        const INSTR_ROOT = "https://psy-ccl.asc.ohio-state.edu/files/instr/acol-14/";
